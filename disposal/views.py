...
def create2(request):
    ...
    disposal.writer=request.user.username
    disposal.name=request.user.profile.name
    disposal.item=request.POST['item']
    disposal.address=request.user.profile.address
    disposal.phone=request.user.profile.phone
